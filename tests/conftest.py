...
sync_session_maker_test = sessionmaker(sync_engine_test, expire_on_commit=True)
...
# Создание тестового синхронного клиента
@pytest.fixture(scope="session")
def get_sync_client() -> Generator[TestClient, None, None]:
    with TestClient(app=app, base_url="http://test") as sync_client:  # Для синхронной работы клиента FastAPI использует собственный класс TestClient
        yield sync_client
